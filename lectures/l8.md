...
lessons: 
  - title: "Concurrency Patterns in Typescript"
    ppt: "Module 08 Concurrency.pptx"
    pdf: "Module 08 Concurrency.pdf"
...
### Important Dates:
* Individual Project 2 **Due Wednesday, Oct 7 by 5pm (EST)**{: .label .label-red }
* Preliminary Project Plan **Due Friday, Oct 16, 2026 by 5pm (ET)**{: .label .label-red } 
...
### Resources
* [Code Examples from Slides](https://github.com/neu-se/m08-concurrency-examples-fall-2026)
