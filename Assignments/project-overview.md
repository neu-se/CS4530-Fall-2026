...
| 10/16/2026 | Preliminary Project Plan | Propose a new feature for GameNite project that can be planned and implemented within 5 weeks |
...
Your features should be something that can be implemented within the timeframe allotted (4-5 weeks), and will be implemented in a fork of the main codebase.
Given that you will be up-to-speed on the project codebase (and have been introduced to TypeScript, React, NodeJS, and testing frameworks), and that you will have a team of three or four, we expect that the feature that you propose will be more complex than the feature implemented in the individual projects.
...
The schedule for sprints will be as follows:
  - Sprint 0: Oct 16-Oct 30
  - Sprint 1: Oct 31-Nov 6 (Sprint 1 is just a single week)
  - Sprint 2: Nov 7-Nov 20
  - Sprint 3: Nov 21-Dec 04
...
The details for the final project deliverable and associated rubrics will be released by Week 9.